...
public final class NoteListItemBinding implements ViewBinding {
  ...
  private NoteListItemBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivOpen,
  ...
  public static NoteListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.iv_open;
      ImageView ivOpen = rootView.findViewById(id);
      if (ivOpen == null) {
        break missingId;
      }
      ...
      return new NoteListItemBinding((ConstraintLayout) rootView, ivOpen, tvNoteTitle);
    }
